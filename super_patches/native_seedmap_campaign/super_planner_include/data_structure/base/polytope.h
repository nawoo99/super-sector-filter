...
namespace geometry_utils {
    ...
    class Polytope {
        ...
        MatD4f planes;
        std::vector<uint8_t> face_obstacle_flags_;
        bool have_seed_line{false};
    public:
        template <class Archive>
        void serialize(Archive& archive) {
            archive(undefined, is_known_free, planes,
                    face_obstacle_flags_, have_seed_line,
        ...
        const std::vector<uint8_t> &GetFaceObstacleFlags() const;
        ...
        void SetFaceObstacleFlags(std::vector<uint8_t> flags);
