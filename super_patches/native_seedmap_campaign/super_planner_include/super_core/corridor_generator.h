...
#define DEBUG_FILE_DIR(name) (string(string(ROOT_DIR) + "log/"+name))
    ...
    private:
        ...
        double robot_r_;
        bool use_inflated_obstacles_{false};
        bool use_inflated_seed_lines_{false};
    ...
    public:
        ...
        CorridorGenerator(const ros_interface::RosInterface::Ptr &ros_ptr,
                          ...
                          const double corridor_pref_margin = -1.0,
                          const bool use_inflated_obstacles = false,
                          const bool use_inflated_seed_lines = false);
