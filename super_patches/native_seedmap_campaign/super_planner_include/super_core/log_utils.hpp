...
namespace super_planner {
    ...
    public:
        ...
        void reset() {
            ...
            // pc_for_sfc is by far the largest field in a dense-map replan
            // record.  It used to survive reset and keep its high-water
            // capacity even after the corresponding record was consumed.
            vec_Vec3f{}.swap(pc_for_sfc);
        }
        ...
        void setSfcPc(vec_Vec3f pc) {
            pc_for_sfc = std::move(pc);
        }
