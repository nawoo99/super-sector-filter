...
namespace ros_interface {
    ...
    public:
        ...
        explicit Ros2Interface(const rclcpp::Node::SharedPtr nh)
            ...
            /*=============================FOR external replan-status consumers ==============*/
            const rclcpp::QoS status_qos(rclcpp::QoS(10).best_effort().keep_last(10).durability_volatile());
            replan_status_pub_ = nh_->create_publisher<std_msgs::msg::Bool>("/planning/replan_status", status_qos);
        }
        ...
        /*=============================FOR external replan-status consumers ==============*/
        void pubReplanStatus(const bool &ok) override {
            std_msgs::msg::Bool msg;
            msg.data = ok;
            replan_status_pub_->publish(msg);
        }
    ...
    private:
        ...
        rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr replan_status_pub_;
    };
}
