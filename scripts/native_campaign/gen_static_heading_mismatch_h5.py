#!/usr/bin/env python3
"""Generate the frozen shm1_h5 blind-fork static topology pair."""
...
MANIFEST_PATH = SCRIPT_DIR / "static_heading_mismatch_h5_manifest.json"
MAP_CLEAR = "shm1_h5_clear"
MAP_HAZARD = "shm1_h5_hazard"
INITIAL_POSITION = (24.5, 0.0, 1.5)
INITIAL_YAW_RAD = math.pi
MISSION_WAYPOINTS = ((24.5, 20.0),)
WALLS = (
    Wall("west_wall", (20.0, -3.0), (20.0, 23.0)),
    Wall("east_wall", (28.0, -3.0), (28.0, 23.0)),
    Wall("route_divider", (23.5, 2.0), (23.5, 15.0)),
)
HAZARD_WALL = Wall("east_branch_closure", (23.5, 8.0), (27.85, 8.0))
AUDIT_CENTER = (25.0, 8.0)
AUDIT_RADIUS_M = 1.0
REPLAY_POSITION = (24.5, 1.0, 1.5)
REPLAY_YAW_DEG = 180.0
REPLAY_VELOCITY = (0.0, 7.0, 0.0)
REPLAY_TRAJECTORY_END = (24.5, 9.0, 1.5)
...
def generate() -> dict:
    ...
    manifest = {
        "schema": "static-heading-mismatch-v5",
        "role": "exploratory blind-fork topology with retained near-field bubble",
        "predecessor": "shm1_h4",
        "maps": maps,
