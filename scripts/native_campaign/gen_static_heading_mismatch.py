#!/usr/bin/env python3
"""Generate the preregistered shm1_h1 static heading-mismatch pair."""
...
MAP_CLEAR = "shm1_h1_clear"
MAP_HAZARD = "shm1_h1_hazard"
...
def generate() -> dict:
    ...
    manifest = {
        "schema": "static-heading-mismatch-v1",
        "role": "preregistered exploratory static yaw-velocity mismatch",
        "preregistration": "docs/static_heading_mismatch_preregistration_20260909.md",
        "maps": maps,
        ...
        "route_check": {
            ...
            "bypass_anchors_xy_m": [[24.0, 0.0], [26.0, 3.0], [26.0, 7.0], [24.0, 20.0]],
            "direct_route_segment_xy_m": [[24.0, 0.0], [24.0, 20.0]],
        },
        "visibility_check": {
