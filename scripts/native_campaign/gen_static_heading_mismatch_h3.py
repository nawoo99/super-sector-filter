#!/usr/bin/env python3
"""Generate the frozen shm1_h3 transverse-wall heading-mismatch pair."""
...
MANIFEST_PATH = SCRIPT_DIR / "static_heading_mismatch_h3_manifest.json"
MAP_CLEAR = "shm1_h3_clear"
MAP_HAZARD = "shm1_h3_hazard"
MISSION_WAYPOINTS = ((24.0, 20.0),)
MISSION_YAW_RAD = INITIAL_YAW_RAD
HAZARD_WALL = Wall("transverse_blind_wall", (23.0, 2.5), (27.85, 2.5))
AUDIT_CENTER = (24.2, 2.5)
AUDIT_RADIUS_M = 0.80
REPLAY_POSITION = INITIAL_POSITION
REPLAY_YAW_DEG = 180.0
REPLAY_VELOCITY = (0.0, 7.0, 0.0)
REPLAY_TRAJECTORY_END = (24.0, 4.0, 1.5)
...
def generate() -> dict:
    ...
    manifest = {
        "schema": "static-heading-mismatch-v3",
        "role": "exploratory persistent-yaw transverse-wall topology",
        "predecessor": "shm1_h2",
        "maps": maps,
        ...
        "route_check": {
            ...
            "bypass_anchors_xy_m": [
                [24.0, 0.0], [21.5, 1.5], [21.5, 3.5], [24.0, 20.0]
            ],
