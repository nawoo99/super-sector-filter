#!/usr/bin/env python3
"""Generate sbd2_t3 with only the divider east endpoint changed from t2."""
...
from gen_static_two_route_blind_hazard_t2 import DIVIDER_WEST_X


MANIFEST_PATH = SCRIPT_DIR / "static_two_route_blind_hazard_t3_manifest.json"
MAP_CLEAR = "sbd2_t3_clear"
MAP_HAZARD = "sbd2_t3_hazard"
DIVIDER_EAST_X = 18.5
WALLS = (
    Wall("incoming_inner", (21.5, -2.0), (21.5, 18.0)),
    Wall("lower_south", (-2.0, 18.0), (21.5, 18.0)),
    Wall("route_divider", (DIVIDER_WEST_X, 23.0), (DIVIDER_EAST_X, 23.0)),
...
def generate() -> dict:
    ...
    manifest = {
        "schema": "static-two-route-blind-hazard-v3",
        "role": "exploratory sbd2_t3; one-factor redesign after t2 Full failure",
        "predecessor": "sbd2_t2",
        "single_changed_factor": {
            "name": "divider_east_endpoint_x_m",
            "before": 21.5,
            "after": DIVIDER_EAST_X,
        },
        "maps": maps,
        ...
        "route_check": {
            ...
            "divider_east_endpoint_xy_m": [DIVIDER_EAST_X, 23.0],
